...
const routes = [
    ...
    { path: '', component: _components_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_3__["DashboardComponent"], canActivate: [_helpers_auth_guard__WEBPACK_IMPORTED_MODULE_6__["AuthGuard"]] },
...
let AuthenticationService = class AuthenticationService {
    ...
    login(username, password) {
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].url + `/login`, { username, password })
...
/* harmony import */ var _modules_app_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./_modules/app-routing.module */ "./src/app/_modules/app-routing.module.ts");
